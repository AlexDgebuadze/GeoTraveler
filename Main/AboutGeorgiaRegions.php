...
session_start(); 
 $Radjara = $crud->returnTags("Adjara");
 $shQartli = $crud->returnTags("Shida Kartli");
 $smJavakheti = $crud->returnTags("Samtskhe Javakheti");
 $RsamegreloSv = $crud->returnTags("Samegrelo-Zemo Svaneti");
 $RachaLech = $crud->returnTags("Racha-Lechkhumi and Kvemo Svaneti");
 $kvQartli = $crud->returnTags("Kvemo Kartli");
 $Rguria = $crud->returnTags("Guria");
 $Rkakheti = $crud->returnTags("Kakheti");
 $Rimereti = $crud->returnTags("Imereti");
...
<body>
    ...
    <div class="Region">
        ...
        <div class="RegionAbt">
            ...
            <?php while($row = $Rimereti->fetch(PDO::FETCH_ASSOC)) { 
                 $parts = explode(" ",$row['nearAtractions']);
                if(count($parts)==1){
                    $res = str_replace('_', ' ', $row['nearAtractions']) ;
                        echo '<div class="imereti tgbtn"> <a href="hotels.php?region=' .$row['region'] . '&tag='. $res . ' ">'. $res . '</a>  </div>' ;
                }else{
                    for($i = 0; $i<count($parts); $i++){
                        $res = str_replace('_', ' ', $parts[$i]) ;
                        echo '<div class="imereti tgbtn"> <a href="hotels.php?region=' .$row['region'] . '&tag='. $res . ' ">'. $res . '</a>  </div>' ;
                    }
                }
            } 
    ...
    <div class="Region">
        ...
        <div class="RegionAbt">
            ...
            <div class="tagcontainer2">
            <?php while($row = $Rkakheti->fetch(PDO::FETCH_ASSOC)) { 
                 $parts = explode(" ",$row['nearAtractions']);
                if(count($parts)==1){
                    $res = str_replace('_', ' ', $row['nearAtractions']) ;
                        echo '<div class="Kakheti tgbtn"> <a href="hotels.php?region=' .$row['region'] . '&tag='. $res . ' ">'. $res . '</a>  </div>' ;
                }else{
                    for($i = 0; $i<count($parts); $i++){
                        $res = str_replace('_', ' ', $parts[$i]) ;
                        echo '<div class="Kakheti tgbtn"> <a href="hotels.php?region=' .$row['region'] . '&tag='. $res . ' ">'. $res . '</a>  </div>' ;
    ...
    <div class="Region">
        ...
        <div class="RegionAbt">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                ...
                <div class="tagcontainer2">
                <?php while($row = $Rguria->fetch(PDO::FETCH_ASSOC)) { 
                 $parts = explode(" ",$row['nearAtractions']);
                if(count($parts)==1){
                    $res = str_replace('_', ' ', $row['nearAtractions']) ;
                        echo '<div class="guria tgbtn"> <a href="hotels.php?region=' .$row['region'] . '&tag='. $res . ' ">'. $res . '</a>  </div>' ;
                }else{
                    for($i = 0; $i<count($parts); $i++){
                        $res = str_replace('_', ' ', $parts[$i]) ;
                        echo '<div class="guria tgbtn"> <a href="hotels.php?region=' .$row['region'] . '&tag='. $res . ' ">'. $res . '</a>  </div>' ;
    ...
    <div class="Region">
        ...
        <div class="RegionAbt">
            ...
            <div class="tagcontainer2">
            <?php while($row = $kvQartli->fetch(PDO::FETCH_ASSOC)) { 
                 $parts = explode(" ",$row['nearAtractions']);
                if(count($parts)==1){
                    $res = str_replace('_', ' ', $row['nearAtractions']) ;
                        echo '<div class="kvQartli tgbtn"> <a href="hotels.php?region=' .$row['region'] . '&tag='. $res . ' ">'. $res . '</a>  </div>' ;
                }else{
                    for($i = 0; $i<count($parts); $i++){
                        $res = str_replace('_', ' ', $parts[$i]) ;
                        echo '<div class="kvQartli tgbtn"> <a href="hotels.php?region=' .$row['region'] . '&tag='. $res . ' ">'. $res . '</a>  </div>' ;
    ...
    <div class="Region">
        ...
        <div class="RegionAbt">
            ...
            <div class="tagcontainer2">
            <?php while($row = $RachaLech->fetch(PDO::FETCH_ASSOC)) { 
                 $parts = explode(" ",$row['nearAtractions']);
                if(count($parts)==1){
                    $res = str_replace('_', ' ', $row['nearAtractions']) ;
                        echo '<div class="rachaLech tgbtn"> <a href="hotels.php?region=' .$row['region'] . '&tag='. $res . ' ">'. $res . '</a>  </div>' ;
                }else{
                    for($i = 0; $i<count($parts); $i++){
                        $res = str_replace('_', ' ', $parts[$i]) ;
                        echo '<div class="rachaLech tgbtn"> <a href="hotels.php?region=' .$row['region'] . '&tag='. $res . ' ">'. $res . '</a>  </div>' ;
    ...
    <div class="Region">
        ...
        <div class="RegionAbt">
            ...
            <div class="tagcontainer2">
            <?php while($row = $RsamegreloSv->fetch(PDO::FETCH_ASSOC)) { 
                 $parts = explode(" ",$row['nearAtractions']);
                if(count($parts)==1){
                    $res = str_replace('_', ' ', $row['nearAtractions']) ;
                        echo '<div class="samegreloSv tgbtn"> <a href="hotels.php?region=' .$row['region'] . '&tag='. $res . ' ">'. $res . '</a>  </div>' ;
                }else{
                    for($i = 0; $i<count($parts); $i++){
                        $res = str_replace('_', ' ', $parts[$i]) ;
                        echo '<div class="samegreloSv tgbtn"> <a href="hotels.php?region=' .$row['region'] . '&tag='. $res . ' ">'. $res . '</a>  </div>' ;
    ...
    <div class="Region">
        ...
        <div class="RegionAbt">
            ...
            <div class="tagcontainer2">
                <?php while($row = $smJavakheti->fetch(PDO::FETCH_ASSOC)) { 
                 $parts = explode(" ",$row['nearAtractions']);
                if(count($parts)==1){
                    $res = str_replace('_', ' ', $row['nearAtractions']) ;
                        echo '<div class="samcxe tgbtn"> <a href="hotels.php?region=' .$row['region'] . '&tag='. $res . ' ">'. $res . '</a>  </div>' ;
                }else{
                    for($i = 0; $i<count($parts); $i++){
                        $res = str_replace('_', ' ', $parts[$i]) ;
                        echo '<div class="samcxe tgbtn"><a href="hotels.php?region=' .$row['region'] . '&tag='. $res . ' ">'. $res . '</a>  </div>';
    ...
    <div class="Region">
        ...
        <div class="RegionAbt">
            ...
            <div class="tagcontainer2">
            <?php while($row = $shQartli->fetch(PDO::FETCH_ASSOC)) { 
                 $parts = explode(" ",$row['nearAtractions']);
                if(count($parts)==1){
                    $res = str_replace('_', ' ', $row['nearAtractions']) ;
                        echo '<div class="shQartli tgbtn"> <a href="hotels.php?region=' .$row['region'] . '&tag='. $res . ' ">'. $res . '</a>  </div>' ;
                }else{
                    for($i = 0; $i<count($parts); $i++){
                        $res = str_replace('_', ' ', $parts[$i]) ;
                        echo '<div class="shQartli tgbtn"> <a href="hotels.php?region=' .$row['region'] . '&tag='. $res . ' ">'. $res . '</a>  </div>';
    ...
    <div class="Region">
        ...
        <div class="RegionAbt">
            ...
            <div class="tagcontainer2">
            <?php while($row = $Radjara->fetch(PDO::FETCH_ASSOC)) { 
                 $parts = explode(" ",$row['nearAtractions']);
                if(count($parts)==1){
                    $res = str_replace('_', ' ', $row['nearAtractions']) ;
                        echo '<div class="AdjaraTag tgbtn"> <a href="hotels.php?region=' .$row['region'] . '&tag='. $res . ' ">'. $res . '</a>  </div>' ;
                }else{
                    for($i = 0; $i<count($parts); $i++){
                        $res = str_replace('_', ' ', $parts[$i]) ;
                        echo '<div class="AdjaraTag tgbtn"> <a href="hotels.php?region=' .$row['region'] . '&tag='. $res . ' ">'. $res . '</a>  </div>' ;
   ...
   <script>
   function clear_elems(Myelems){
    var elements = Myelems;
        ...
        clear_elems(document.getElementsByClassName("AdjaraTag"));
        clear_elems(document.getElementsByClassName("shQartli"));
        clear_elems(document.getElementsByClassName("samcxe"));
        clear_elems(document.getElementsByClassName("samegreloSv"));
        clear_elems(document.getElementsByClassName("rachaLech"));
        clear_elems(document.getElementsByClassName("kvQartli"));
        clear_elems(document.getElementsByClassName("guria"));
        clear_elems(document.getElementsByClassName("Kakheti"));
        clear_elems(document.getElementsByClassName("imereti"));
   </script> 
</body>