...
<NAV>
    ...
    <div class="Mountains">
        ...
        <div class="MountainContent">
            <div class="Mountainsimg"><img src="images/mountains/Kazbek.jpg"></div>
    ...
    <div class="Mountains">
        <h3>Ushba</h3>
        <div class="MountainContent">
            <div class="Mountainsimg"><img src="images/mountains//Ushba.jpg"></div>
    ...
    <div class="Mountains">
        <h3>Shkhara</h3>
        <div class="MountainContent">
            <div class="Mountainsimg"><img src="images/mountains/Shkhara.jpg"></div>
    ...
    <div class="Mountains">
        <h3>Tetnuld</h3>
        <div class="MountainContent">
            <div class="Mountainsimg"><img src="images/mountains/Tetnuld.jpg"></div>
    ...
    <div class="slider">
        ...
        <div class="imgBox">
            <label for="2"><img src="images/mountains/Kazbek.jpg"></label>
        </div>
        <input type="radio" name="slider" id="2">
        <div class="imgBox">
            <label for="1"><img src="images/mountains//Ushba.jpg"></label>
        </div>
        <input type="radio" name="slider" id="3">
        <div class="imgBox">
            <label for="1"><img src="images/mountains/Shkhara.jpg"></label>
        </div>
        <input type="radio" name="slider" id="4">
        <div class="imgBox">
            <label for="1"><img src="images/mountains/Tetnuld.jpg"></label>
        </div>
    </div>
    <footer class="footer">
